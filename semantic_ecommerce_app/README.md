...
This section introduces the fundamental concepts of tensors, embeddings, and semantic search in Vespa. If you're new to vector search, we recommend reading the detailed explanations in [`docs/ANN_SEARCH.md`](docs/ANN_SEARCH.md) for a deeper understanding.
...
- **Vector Space**: High-dimensional space where similar meanings are close together
...
- See [`docs/ANN_SEARCH.md`](docs/ANN_SEARCH.md) for detailed explanation of tensor usage in semantic search
